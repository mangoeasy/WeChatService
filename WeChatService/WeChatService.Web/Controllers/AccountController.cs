...
namespace WeChatService.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            var userModel = new UserModel { Phone = model.Phone };
            if (!ModelState.IsValid) return View(model);
            var user = _accountService.GetAccounts().FirstOrDefault(n => n.IsDeleted == false && n.Valid && n.Phone == model.Phone && n.Password == model.Password);
            if (user != null)
            {
